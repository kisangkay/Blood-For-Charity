...
<!--    <link rel="stylesheet" href="admin/css/icons_style.css">-->
    ...
    <main role="main">
      ...
      <div class="jumbotron"  style="padding-top: 70px;">
        <div class="container">
          <h2 class="display-5" style="text-align: center; color: yellow">Appointments Requested for Cancellation</h2>
            <hr>
        </div>
      </div>
...
//}
    ...
    *****/
    $select_booking = "SELECT * FROM appointments LEFT JOIN users ON (users.`userId` = appointments.`appointment_booker_id`) WHERE requested_cancellation='1'";
...
//                                <h6>Published on: <?php print date("jS F Y", $art_row["article_publication_date"]); ?><!-- by --><?php //print $art_row["fullName"]; <!--</h6>-->
                        ...
                        echo "<td><a href='data_process/_delete.php?id=".$booking_row['appointmentID']."'><span style='padding-left: 18px' class='fa fa-trash'>";
