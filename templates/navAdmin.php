...
<nav  class="navbar navbar-expand-md navbar-dark fixed-top bg-secondary" style="padding: 1px">
    <a class="navbar-brand" href="#"></a>
<div style="justify-content: flex-start">
  <div class="collapse navbar-collapse" style="padding-left: 0px;  justify-content: flex-start" id="navbarToggleExternalContent">
        <ul class="navbar-nav mr-auto" style="padding-top: 5px;">
            ...
            <li class="nav-item">
                <a class="nav-link" href="admin.php" style="padding-top: 14px;font-size: 14px">Admin</a>
            </li>

            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="view_appointments.php" style="padding-top: 14px;font-size: 13px" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Appointments
                </a>
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="view_appointments.php">Active Appointments</a></li>
                    <li><a class="dropdown-item" href="view_cancellation_requests.php">Requested Cancellations</a></li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="add_article.php" style="padding-top: 14px;font-size: 13px">Post Blog</a>
            </li>
            ...
            <form class="form-inline my-2 my-lg-0 " style="padding-left: 540px;padding-top: 12px">
